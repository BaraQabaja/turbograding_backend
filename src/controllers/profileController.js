    ...
    try{
        ...
        if (!isValidUsername) {
          return res.status(400).json({
              status: httpStatusText.FAIL,
              data: {
                title: "Invalid username. Username can only contain letters, numbers, and underscores.",
              },
            });
        }
...
// @desc     Get profile personal info
// @route    PUT /api/profile/get-personal-info
// @access   protected/user
